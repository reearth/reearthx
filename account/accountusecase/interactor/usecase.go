...
func Run0(ctx context.Context, op *accountusecase.Operator, r *repo.Container, e *uc, f func() error) (err error) {
	_, _, _, err = Run3(
		ctx, op, r, e,
...
func Run1[A any](ctx context.Context, op *accountusecase.Operator, r *repo.Container, e *uc, f func() (A, error)) (a A, err error) {
	a, _, _, err = Run3(
		ctx, op, r, e,
...
func Run2[A, B any](ctx context.Context, op *accountusecase.Operator, r *repo.Container, e *uc, f func() (A, B, error)) (a A, b B, err error) {
	a, b, _, err = Run3(
		ctx, op, r, e,
...
func Run3[A, B, C any](ctx context.Context, op *accountusecase.Operator, r *repo.Container, e *uc, f func() (A, B, C, error)) (_ A, _ B, _ C, err error) {
