...
import (
	...
	"github.com/reearth/reearthx/asset/assetdomain/thread"
	usecase "github.com/reearth/reearthx/asset/assetusecase"
	"github.com/reearth/reearthx/asset/assetusecase/assetgateway"
...
type Asset struct {
	...
	gateways    *assetgateway.Container
	ignoreEvent bool
}

func NewAsset(r *repo.Container, g *assetgateway.Container) interfaces.Asset {
	return &Asset{
		repos:    r,
		gateways: g,
	}
...
func (i *Asset) Create(ctx context.Context, inp interfaces.CreateAssetParam, op *usecase.Operator) (result *asset.Asset, afile *asset.File, err error) {
	...
	a, f, err := usecasex.Run2[*asset.Asset, *asset.File](
		ctx, func(ctx context.Context) (*asset.Asset, *asset.File, error) {
			if inp.Token != "" {
				uuid = inp.Token
...
func (i *Asset) DecompressByID(ctx context.Context, aId id.AssetID, operator *usecase.Operator) (*asset.Asset, error) {
	...
	return usecasex.Run1(
		ctx, func(ctx context.Context) (*asset.Asset, error) {
...
func (i *Asset) CreateUpload(ctx context.Context, inp interfaces.CreateAssetUploadParam, op *usecase.Operator) (*interfaces.AssetUpload, error) {
	...
	var param *assetgateway.IssueUploadAssetParam
	if inp.Cursor == "" {
		if inp.Filename == "" {
		...
		param = &assetgateway.IssueUploadAssetParam{
	...
	if errors.Is(err, assetgateway.ErrUnsupportedOperation) {
...
func (i *Asset) UpdateFiles(ctx context.Context, aid id.AssetID, s *asset.ArchiveExtractionStatus, op *usecase.Operator) (*asset.Asset, error) {
	...
	return usecasex.Run1(
		ctx, func(ctx context.Context) (*asset.Asset, error) {
			...
			if err != nil {
				if err == assetgateway.ErrFileNotFound {
					return nil, err
				}
			...
			assetFiles := lo.FilterMap(files, func(f assetgateway.FileEntry, _ int) (*asset.File, bool) {
				if srcPath == f.Name {
					return nil, false
				}
...
func detectPreviewType(files []assetgateway.FileEntry) *asset.PreviewType {
...
func (i *Asset) Delete(ctx context.Context, aId id.AssetID, operator *usecase.Operator) (result id.AssetID, err error) {
	...
	return usecasex.Run1(
		ctx, func(ctx context.Context) (id.AssetID, error) {
			a, err := i.repos.Asset.FindByID(ctx, aId)
			if err != nil {
				return aId, err
			}
