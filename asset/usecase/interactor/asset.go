...
func (i *Asset) FindFileByID(ctx context.Context, aid id.AssetID, _ *usecase.Operator) (*file.File, error) {
...
func (i *Asset) FindFilesByIDs(ctx context.Context, ids id.AssetIDList, _ *usecase.Operator) (map[id.AssetID]*file.File, error) {
...
func (i *Asset) Create(ctx context.Context, inp interfaces.CreateAssetParam, op *usecase.Operator) (result *asset.Asset, afile *file.File, err error) {
	...
	a, f, err := Run2(
		ctx, op, i.repos,
		Usecase().Transaction(),
		func(ctx context.Context) (*asset.Asset, *file.File, error) {
			if inp.Token != "" {
				uuid = inp.Token
...
func (i *Asset) triggerDecompressEvent(ctx context.Context, a *asset.Asset, f *file.File) error {
...
func (i *Asset) UpdateFiles(ctx context.Context, aid id.AssetID, s *asset.ArchiveExtractionStatus, op *usecase.Operator) (*asset.Asset, error) {
	...
	return Run1(
		...
		func(ctx context.Context) (*asset.Asset, error) {
			...
			assetFiles := lo.FilterMap(files, func(f gateway.FileEntry, _ int) (*file.File, bool) {
				if srcPath == f.Name {
					return nil, false
				}
				return file.NewFile().
