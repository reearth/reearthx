...
type Usecase interface {
	...
	UploadAssetContent(ctx context.Context, id id.ID, content io.Reader) error
	// DownloadAssetContent retrieves the content of an asset by ID
	DownloadAssetContent(ctx context.Context, id id.ID) (io.ReadCloser, error)
	...
	DeleteAllAssetsInGroup(ctx context.Context, groupID id.GroupID) error
}
